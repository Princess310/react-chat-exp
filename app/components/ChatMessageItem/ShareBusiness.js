...
class ShareBusiness extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  state = {
    openDialog: false,
  }
    ...
    const ChatBubbleElement = (
      <div>
        ...
        <Dialog
          ...
          bodyStyle={{ padding: 0 }}
        >
          <iframe src={`${request.getWebRoot()}/index.html#businessInfo!id=${id}&name=${title}`} width="100%" height="640"></iframe>
        </Dialog>
      </div>
    );
